...
# 定义项目根目录下的 build_gradle 配置
_project_build_gradle_set_file_path = "/Users/addcn/flutter/packages/flutter_tools/templates/module/android/gradle"
# 定义项目 app 目录下的 build_gradle 配置
_app_build_gradle_set_file_path = "/Users/addcn/flutter/packages/flutter_tools/templates/module/android/host_app_common/app.tmpl"

# 定义需要写入的 android 项目根目录的 build_gradle 配置
_build_gradle_tmpl_for_project_path = "/build_gradle_tmpl_for_project.txt"

# 定义需要写入的 app 目录的 build_gradle 配置
...
def set_app_build_gradle_file():
    ...
    write_file_path = concurrent + "/build.gradle.tmpl"
    # mkdir(check_path)
    set_build_gradle_file(read_file_path, write_file_path)
